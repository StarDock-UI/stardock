...
import { Rocket, Package, Dna, Hammer, Folder, BookOpen } from 'lucide-react';
    ...
    <div className="docs-container">
      ...
      <div className="main-content">
        ...
        <div className="content-section">
          <h2><Rocket size={20} style={{ marginRight: '8px' }} /> Getting Started with StarDock</h2>
          <p>
          ...
          <h2><BookOpen size={20} style={{ marginRight: '8px' }} /> Next Steps</h2>
