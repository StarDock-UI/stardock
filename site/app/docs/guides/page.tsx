    ...
    <div className="docs-container">
      ...
      <div className="main-content">
        ...
        <div className="content-section">
          ...
          <ul>
            <li>
              <strong><MoonStar size={16} style={{ marginRight: 6 }} /> Dark Mode Support</strong> – Enable dark mode with one utility class and customize it to your brand.
            </li>
            <li>
              <strong><LayoutGrid size={16} style={{ marginRight: 6 }} /> Responsive Layouts</strong> – Create flexible grid systems using StarDock layout utilities.
            </li>
            <li>
              <strong><Code size={16} style={{ marginRight: 6 }} /> Framework Integration</strong> – Use StarDock with React, Vue, or plain HTML/JS setups.
            </li>
          </ul>
