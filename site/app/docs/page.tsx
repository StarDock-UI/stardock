    ...
    <div className="docs-container">
      ...
      <div className="main-content">
        ...
        <div className="content-section">
          ...
          <h2><Paintbrush size={20} /> Why StarDock?</h2>
          <ul>
            <li><Paintbrush size={16} /> Pre-styled, customizable components</li>
            <li><Zap size={16} /> Fast setup with zero config</li>
            <li><PackageCheck size={16} /> Modular and extensible architecture</li>
            <li><Globe size={16} /> Works with any modern JavaScript framework</li>
          </ul>

          <h2><Rocket size={20} /> Quick Start</h2>
          ...
          <h2><BookOpen size={20} /> Explore Components</h2>
          ...
          <ul>
            ...
            <li><Link href="/docs/components/layouts">Grid & Layouts</Link></li>
            <li><Link href="/docs/components/alerts">Alerts & Notifications</Link></li>
          </ul>

          <h2><Puzzle size={20} /> Built With Flexibility</h2>
          <p>
          ...
          <h2><Users size={20} /> Join the Community</h2>
          <p>
          ...
          <Link href="/docs/getting-started" ref={rightLinkRef}>
            <span className="Doc-button right-button">
              Getting Started <ArrowRight size={16} style={{ marginLeft: '6px' }} />
            </span>
          </Link>
        </div>
      </div>
