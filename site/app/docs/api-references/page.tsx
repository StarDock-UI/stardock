		...
		<div className='docs-container'>
			...
			<div className='main-content'>
				...
				<div className='content-section'>
					...
					<p>
						StarDock exposes a flexible API to allow you to interact with themes,
						components, and design tokens programmatically. This section covers
					...
					<p>
						All API requests must be authenticated using a bearer token. You can
						generate your API key in the dashboard under{' '}
